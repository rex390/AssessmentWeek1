...
public class Player extends Character
{
	...
	public Spells getSpellFromList(int spellNumber)
	{
		Spells spell = spellList.get(spellNumber);
		return spell;
	}
	public void loadSpells()
	{
		...
		for(Spells spell:spellList)
		{
			...
			if(this.level>= spell.getLevelRequired())
			{
				System.out.println(counter + "---| " + spell.getName() + " |mana cost:" + spell.getManaCost() + "mana");
			}
		}
	}
